...
function codegen(params) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        let apiSource = options.useCustomerRequestInstance ? serviceHeader_1.customerServiceHeader(options) : serviceHeader_1.serviceHeader(options);
        ...
        if (true) {
            ...
            Object.values(enums).forEach(item => {
                const text = item.value ? template_1.enumTemplate(item.value.name, item.value.enumProps, 'Enum') : item.content || '';
...
//# sourceMappingURL=index.multipleFile.js.map